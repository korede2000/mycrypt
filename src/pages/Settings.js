        ...
        <div className='col-xl-9 col-md-8'>
            <div className='row'>
                        ...
                        <div class="card-body">
                            <form action="#">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-xl-12">
                                        <div class="media align-items-center mb-3" style={{border:'none', paddingBottom:'0'}}> 
                                            <img class="mr-3 rounded-circle mr-0 mr-sm-3" src={Team} width="55" height="55" alt="" />
                                    ...
                                    <div class="col-12">
                                        <button class="btn btn-success btn-dashboard waves-effect">Save</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Social Media Info</h4>
                        </div>
                        <div class="card-body">
                            <form action="#">
                                <div class="form-row">
                                    <div class="form-group col-xl-12">
                                        <label class="mr-sm-2">Facebook URL</label>
                                        <input type="text" class="form-control" placeholder="http://www.facebook.com/link" />
                                    </div>
                                    <div class="form-group col-xl-12">
                                        <label class="mr-sm-2">Twitter URL</label>
                                        <input type="text" class="form-control" placeholder="http://www.twitter.com/link" />
                                    </div>
                                    <div class="form-group col-xl-12">
                                        <label class="mr-sm-2">WhatsApp URL</label>
                                        <input type="text" class="form-control" placeholder="http://www.whatsapp.com/link" />
                                        <p class="mt-2 mb-0">Enable two factor authencation on the security page</p>
                                    </div>
                                    <div class="col-12">
                                        <button class="btn btn-success waves-effect btn-dashboard">Save</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-xl-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="10-10-2019" id="datepicker" autocomplete="off" name="dob" />
                                </div>
                                <div class="form-group col-xl-6">
